const FooterLogo = () => {
  return (
    <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" width="164" height="48" viewBox="0 0 164 48">
      ...
      ></path>
      <path fill="#FFFFFF" d="M125.1,14.8c0.7,0,1.4,0,2.1,0c0,5.9,0,11.9,0,17.9c-0.7,0-1.4,0-2.1,0C125.1,26.7,125.1,20.8,125.1,14.8z"></path>
      <polygon fill="#FFB441" points="87.6,24.5 87.6,24.5 87.6,24.5 87.6,24.5 	"></polygon>
      <path
        fill="#000000"
      ...
      ></path>
      <polygon fill="#FFB441" points="81.2,20.3 81.2,20.3 81.2,20.3 81.2,20.3 	"></polygon>
      <path fill="#FFFFFF" d="M89.8,24.1C89.8,24.2,89.8,24.2,89.8,24.1C89.8,24.2,89.8,24.2,89.8,24.1z"></path>
      <path
        fill="#FFFFFF"
      ...
      ></path>
      <polygon fill="#FFB441" points="101.8,22.6 101.8,22.6 101.8,22.6 101.8,22.6 	"></polygon>
      <path fill="#FFB441" d="M16.8,30.2c0-4.3,0-8.6,0-12.9c2.4,0.2,5.5,2.3,5.7,6.1C22.8,27.1,19.9,29.9,16.8,30.2z"></path>
      <path fill="#FFB441" d="M15.3,30.2c-2.9-0.3-5.7-2.8-5.7-6.4c-0.1-3.6,2.7-6.3,5.7-6.6C15.3,21.6,15.3,25.9,15.3,30.2z"></path>
    </svg>
  );
};
